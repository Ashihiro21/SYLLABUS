...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 27, 2024 at 10:35 AM
...
INSERT INTO `course_syllabus` (`id`, `course_code`, `course_tittle`, `course_Type`, `course_credit`, `learning_modality`, `pre_requisit`, `co_pre_requisit`, `professor`, `consultation_hours`, `course_description`) VALUES
(1, 'S-ITPC 121', 'Fundamentals of Database Systems', 'Laboratory', '3 Units', 'Fully Onsite', 'None', 'S-ITPC 121LA', 'Ms. Azenith R. Mojica', 'Monday and Tuesday 2:00-5:00 COS 100-C\r\narmojica@dlsud.edu.ph\r\n(046) 4811900 local 3134', 'This course prepares the students to acquire the skills on creating, analyzing, and designing databases. This will help increase their understanding of the essentials of database modelling and design, the languages and facilities provided by the database');

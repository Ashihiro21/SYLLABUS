...
--
-- Host: 127.0.0.1
-- Generation Time: May 06, 2024 at 05:59 AM
...
(7, 2, ' Bachelor of Science in Entrepreneurship with Specialization in Food Entrepreneurship    ', 'ABD', ' Allied Business Department ', ' Renz S. Mercado, MBA ', ' Chair  ', '', 'uploads/Picture1.png'),
...
(31, 6, ' Bachelor of Arts in Communication ', '  CJD', '  Communication and Journalism Department', ' Isolde E. Valera, MAComm', '  Chair', '', 'No Signature'),
(32, 6, ' Bachelor of Arts in Digital and Multimedia Journalism ', '  CJD', '  Communication and Journalism Department', 'Isolde E. Valera, Macomm', '  Chair', '', 'No Signature'),
(33, 6, '  Bachelor of Arts in Political Science  ', ' SHD ', ' Social and Humanities Department ', ' Chealyn J. Rudio, PhD ', '   Chair ', '', 'No Signature'),
(34, 6, '  Bachelor of Arts in International Development  ', ' LLD ', ' Languages and Literature Department ', ' Lourdes C. Rudio, PhD ', '   Chair ', '', 'No Signature'),
(35, 6, '  Bachelor of Arts in Psychology  ', ' SHD ', ' Social and Humanities Department ', ' Chealyn J. Rudio, PhD ', '   Chair ', '', 'No Signature'),
(36, 6, ' Bachelor of Science in Psychology ', 'SHD', 'Social and Humanities Department', 'Chealyn J. Rudio, PhD', '  Chair', '', 'No Signature'),
(37, 7, '  Bachelor of Science in Biology with specialization in Medical Biology (3 year compressed program)  ', '   BSD ', ' Biological Sciences Department ', '   Ronaldo D. Lagat, PhD   ', '   Chair ', '', 'No Signature'),
(38, 7, '   Bachelor of Science in Biology with specialization in Medical Biology   ', '    BSD  ', '  Biological Sciences Department  ', '    Ronaldo D. Lagat, PhD  ', '    Chair  ', '', 'No Signature'),
(39, 7, '    Bachelor of Science in Biology with specialization in Microbiology    ', '     BSD   ', '  Biological Sciences Department  ', '   Ronaldo D. Lagat, PhD', '     Chair   ', '', 'No Signature'),
(40, 7, '     Bachelor of Science in Biology with specialization in Cell and Molecular Biology     ', '    BSD    ', '    Biological Sciences Department    ', '    Ronaldo D. Lagat, PhD', ' Chair  ', '', 'No Signature'),
(41, 7, '   Bachelor of Science in Biology with specialization in Plant Biology   ', '    BSD  ', '  Biological Sciences Department  ', '    Ronaldo D. Lagat, PhD   ', '    Chair  ', '', 'No Signature'),
(42, 7, '   Bachelor of Science in Biology with specialization in Animal Biology   ', '    BSD  ', '  Biological Sciences Department  ', '    Ronaldo D. Lagat, PhD', '  Chair  ', '', 'No Signature'),
(43, 7, '  Bachelor of Science in Biology with specialization in Environmental Science  ', '   PSD ', '   Physical Sciences Department ', '   Susan T. Sta Ana ', '  Chair', '', 'No Signature'),
(44, 7, '  Bachelor of Science in Applied Mathematics  ', ' MSD ', ' Mathematics and Statistics Department ', ' Sharon P. Lubag, MSAM ', '  Chair', '', 'No Signature'),
(45, 7, '   Bachelor of Science in Computer Science   ', '  CSD   ', '   Computer Science Department  ', '    Josephine T. Eduardo, MSCS  ', '   Chair ', '', 'No Signature'),
...
(16, 'CLO1', 'Design data models, schemas, instances, and their applications in the real world.', 'TLO1. Effectively explains the basic concepts of databases and data models. \r\n \r\nTLO2.Explains the features of database management systems, architecture of database systems, and the role of database users. \r\n \r\nTLO3. Defines the basics of the relational data model. ', '8'),
...
(19, 'CLO2', 'Design effective database schemas using Entity Relationship Diagram (ERD). ', 'TLO4. State reasons why many system developers believe that data modeling is the most important part of the systems development process. \r\n \r\nTLO5. Write good names and definitions for entities, relationships, and attributes. \r\n \r\nTLO6. Draw an E-R diagram to represent common business situations. \r\n \r\nTLO7. Recognize when to use supertype/subtype relationships in data modeling. \r\n \r\nTLO8. Develop a supertype/subtype hierarchy for a realistic business situation. \r\n \r\nTLO9. Develop an entity cluster to simplify presentation of an E-R diagram. \r\n', '4'),
...
(23, 'CLO1', 'Understand data models, schemas, instances, and their applications in the real world. ', 'TLO1. Effectively explains the basic concepts of databases and data models. \r\n \r\nTLO2.Explains the features of database management systems, architecture of database systems, and the role of database users. \r\n \r\nTLO3. Defines the basics of the relational data model. ', '7'),
(24, 'CLO2', 'Design effective database schemas using Entity Relationship Diagram (ERD). ', 'TLO4. State reasons why many system developers believe that data modeling is the most important part of the systems development process. \r\n \r\nTLO5. Write good names and definitions for entities, relationships, and attributes. \r\n \r\nTLO6. Draw an E-R diagram to represent common business situations. \r\n \r\nTLO7. Recognize when to use supertype/subtype relationships in data modeling. \r\n \r\nTLO8. Develop a supertype/subtype hierarchy for a realistic business situation. \r\n \r\nTLO9. Develop an entity cluster to simplify presentation of an E-R diagram. \r\n \r\n', '7'),
(25, 'CLO3', 'Convert conceptual model into relational schema.', '', '7'),
(26, 'CLO4', 'Perform effective data management procedures. ', '', '7'),
(27, 'CLO5.', 'Perform effective logical database design.', '', '7'),
(28, 'CLO6', 'Demonstrate 21st century skills in all learning activities. ', '', '7');
...
INSERT INTO `laerning_final` (`id`, `comlab`, `final_learning_out`, `final_topic_leaning_out`, `department`) VALUES
...
CREATE TABLE `practice` (
  ...
  `course_learn_out` varchar(255) NOT NULL,
  `department` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'CLO1', 'Design effective database schemas using Entity Relationship Diagram (ERD). ', '8'),
(2, 'CLO2', 'Assemble effective database schemas using Entity Relationship Diagram (ERD). ', '8'),
(3, 'CLO3', 'Construct effective database schemas using Entity Relationship Diagram (ERD). ', '8'),
(4, 'CLO4', 'Execute effective database schemas using Entity Relationship Diagram (ERD). ', '8'),
(5, 'CLO5', 'Implement effective database schemas using Entity Relationship Diagram (ERD). ', '8'),
(6, 'CLO6', 'Solve effective database schemas using Entity Relationship Diagram (ERD). ', '8'),
(7, 'CLO7', 'Use effective database schemas using Entity Relationship Diagram (ERD). ', '8'),
(8, 'CLO8', 'Interpret effective database schemas using Entity Relationship Diagram (ERD). ', '8'),
(9, 'CLO9', 'Demonstrate effective database schemas using Entity Relationship Diagram (ERD). ', '8');
...
(24, 'Jenesis', 'Falceso', '4', '17', '09514781767', 'jenesis123@gmail.com', '$2y$10$Jud1nO0wLasxvB6FqT3bd.hPlMgFvhPkfFd0/032KV41eGcA6zH2i', '1', 'user');

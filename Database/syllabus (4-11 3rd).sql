...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 11, 2024 at 05:25 AM
...
(7, 'College of Science and Computer Studies', 'CSCS', 'Dr. Mario Torres', 'Dean'),
...
INSERT INTO `course` (`id`, `catid`, `cname`, `initial`, `course_department`, `department_name`, `department_position`) VALUES
...
(46, 7, 'Bachelor of Science in Information Technology', 'ITD', 'Information Technology Department', 'Marivic Mitschek', 'Chair'),
(47, 8, 'Bachelor of Science Hospitality Management\r\n', 'DOM', '', '', ''),
(48, 8, 'Bachelor of Science in in Tourism Management', 'DOM', '', '', ''),
(49, 4, 'Bachelor of Physical Education', 'PED', 'CHED', '', '');
...
CREATE TABLE `graduates_attributes` (
  ...
  `descriptors_learn_out` varchar(455) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(14, '<p>ASDSADSAD</p>', 'Week 4', 'Feb 20-25', '<p>SADSADASDA</p>', 'Schoolbook', '1', '', '2');
...
INSERT INTO `users` (`id`, `first_name`, `last_name`, `department`, `catid`, `phone_number`, `email`, `password`, `position`) VALUES
(7, 'Marivic', 'Mitscheck', '7', '46', '09505934815', 'Marivic.Mitscheck@lassalle.edu.ph', '$2y$10$oIV/VlCsi11.aqeaHP1Bie.lCjq7ZAMF0AdsO8iCUppBPvq511i36', '1'),
...
(15, 'John', 'Falceso', '7', '46', '09505934815', 'john.falceso@cvsu.edu.ph', '$2y$10$hlIweTu04suMdSk/PqOJteSAAkqM9kfqGxWkvhiZghAFpPMDL4A3q', '1');
